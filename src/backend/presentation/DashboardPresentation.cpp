...
QVariantList DashboardPresentation::settingsSchema() const
{
    return {
        ...
        QVariantMap{{QStringLiteral("key"), QStringLiteral("webSecureCookies")},
                    {QStringLiteral("group"), QStringLiteral("web")},
                    {QStringLiteral("type"), QStringLiteral("boolean")}},
        QVariantMap{{QStringLiteral("key"), QStringLiteral("webDeploymentProfile")},
                    {QStringLiteral("group"), QStringLiteral("web")},
                    {QStringLiteral("type"), QStringLiteral("select")},
                    {QStringLiteral("options"), QVariantList{
                         QStringLiteral("localhost"), QStringLiteral("lan"),
                         QStringLiteral("vpn"), QStringLiteral("reverse_proxy")}},
                    {QStringLiteral("readOnly"), true}},
        QVariantMap{{QStringLiteral("key"), QStringLiteral("webExternalBaseUrl")},
                    {QStringLiteral("group"), QStringLiteral("web")},
                    {QStringLiteral("type"), QStringLiteral("string")},
                    {QStringLiteral("readOnly"), true}},
        QVariantMap{{QStringLiteral("key"), QStringLiteral("webExternalWebSocketUrl")},
                    {QStringLiteral("group"), QStringLiteral("web")},
                    {QStringLiteral("type"), QStringLiteral("string")},
                    {QStringLiteral("readOnly"), true}},
        QVariantMap{{QStringLiteral("key"), QStringLiteral("webTrustedProxyAddresses")},
                    {QStringLiteral("group"), QStringLiteral("web")},
                    {QStringLiteral("type"), QStringLiteral("string")},
                    {QStringLiteral("readOnly"), true}},
