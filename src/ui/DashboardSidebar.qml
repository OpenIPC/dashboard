    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                Repeater {
                    model: [
                        ...
                        { iconPath: "M12 2L4 5v6c0 5.55 3.84 10.74 8 12 4.16-1.26 8-6.45 8-12V5l-8-3zm0 2.18L18 6.4V11c0 4.52-2.98 8.69-6 9.82-3.02-1.13-6-5.3-6-9.82V6.4l6-2.22zm-1 4.82h2v5h-2V9zm0 6h2v2h-2v-2z", action: "health", label: "Здоров.", tooltip: "Здоровье камер и диагностика" },
                    ...
                    SidebarActionButton {
                        ...
                        iconPath: sidebarAction.modelData.iconPath
                        label: sidebarAction.modelData.label
                        tooltip: sidebarAction.modelData.tooltip
                        enabled: sidebar.actionAllowed(sidebarAction.modelData.action)
                        onClicked: sidebar.triggerAction(sidebarAction.modelData.action)
                    }
                }
                ...
                SidebarActionButton {
                    ...
                    enabled: sidebar.actionAllowed("camex")
                    onClicked: sidebar.triggerAction("camex")
                }
            }
            ...
            Text {
                ...
                text: I18n.t("Пользователь: ") + sidebar.currentUsername()
            ...
            RowLayout {
                ...
                SidebarStatPill {
                    title: I18n.t("Всего")
                    value: String(sidebar.cameraCount())
                    accentColor: Theme.textPrimary
                }

                SidebarStatPill {
                    title: I18n.t("Онлайн")
                    value: String(sidebar.onlineCameraCount())
                    accentColor: Theme.success
                }

                SidebarStatPill {
                    title: I18n.t("Офлайн")
                    value: String(Math.max(0, sidebar.cameraCount() - sidebar.onlineCameraCount()))
            ...
            RowLayout {
                ...
                SidebarStatPill {
                    title: I18n.t("Активно")
                    value: String(sidebar.activePreviewCount()) + "/" + String(sidebar.previewBudgetLimit())
                    accentColor: Theme.success
                }

                SidebarStatPill {
                    title: I18n.t("Пауза")
                    value: String(sidebar.budgetPausedPreviewCount())
                    accentColor: Theme.warning
                }

                SidebarStatPill {
                    title: I18n.t("Лимит")
                    value: String(sidebar.previewBudgetLimit())
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        property bool isDefaultGroup: groupBlockItem.isDefaultGroup
                                        property string groupName: groupBlockItem.groupName
                                    ...
                                    Rectangle {
                                        ...
                                        Text {
                                            property int groupCount: groupBlockItem.groupCount
                                ...
                                MouseArea {
                                    ...
                                    onClicked: (mouse) => {
                                        if (mouse.button === Qt.RightButton && !isDefaultGroup)
                                            sidebar.groupContextRequested(groupName)
                                    }
                                }
                            }
                            ...
                            ListView {
                                ...
                                delegate: Rectangle {
                                    ...
                                    property string effectiveStatus: sidebar.effectiveCameraStatus(deviceRow.cameraIp, deviceRow.status)
                                    property string effectiveDetail: sidebar.effectiveCameraDetail(deviceRow.cameraIp, deviceRow.status)
                                    property bool inGroup: (deviceRow.cameraGroup || "") === groupBlockItem.groupName
                                                           && sidebar.cameraMatchesDeviceFilter(deviceRow.cameraName, deviceRow.cameraIp,
                                                                                                deviceRow.effectiveStatus + " " + deviceRow.effectiveDetail,
                                                                                                deviceRow.cameraGroup)

                                    width: ListView.view ? ListView.view.width : parent.width
                                    height: inGroup ? (effectiveDetail !== "" ? 64 : 50) : 0
                                    visible: inGroup
                                    color: deviceRowHover.hovered ? "#2a2d2e" : "transparent"

                                    HoverHandler {
                                        id: deviceRowHover
                                    }

                                    ToolTip.visible: deviceRowHover.hovered && effectiveDetail !== ""
                                    ToolTip.text: I18n.t(effectiveDetail)
                                    ToolTip.delay: 500
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: (mouse) => {
                                            if (mouse.button === Qt.RightButton) {
                                                ...
                                                sidebar.deviceContextRequested(deviceRow.cameraIp, deviceRow.cameraName, deviceRow.rowCameraIndex)
                                            }
                                        }

                                        onDoubleClicked: sidebar.addCameraToGridRequested(deviceRow.rowCameraIndex)

                                        drag.target: sidebar.canSettings && sidebar.dragProxyItem ? sidebar.dragProxyItem : null
                                        ...
                                        onPressed: (mouse) => {
                                            ...
                                            if (mouse.button === Qt.LeftButton && sidebar.dragProxyItem && sidebar.dashboard) {
                                                var pos = mapToItem(sidebar.dashboard, mouse.x, mouse.y)
                                                sidebar.dragProxyItem.x = pos.x - sidebar.dragProxyItem.width / 2
                                                sidebar.dragProxyItem.y = pos.y - sidebar.dragProxyItem.height / 2
                                                sidebar.dragProxyItem.proxyIp = deviceRow.cameraIp
                                                sidebar.dragProxyItem.proxyName = deviceRow.cameraName || ""
                                                sidebar.dragProxyItem.dragIndex = deviceRow.rowCameraIndex
                                            }
                                        }

                                        onReleased: {
                                            if (sidebar.dragProxyItem) {
                                                sidebar.dragProxyItem.visible = false
                                                sidebar.dragProxyItem.x = 0
                                                sidebar.dragProxyItem.y = 0
                                            }
                                        }

                                        drag.onActiveChanged: {
                                            if (sidebar.dragProxyItem)
                                                sidebar.dragProxyItem.visible = drag.active
                                        }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        CameraStatusBadge {
                                            ...
                                            dotSize: 8
                                            showText: false
                                            online: sidebar.isOnlineStatus(deviceRow.effectiveStatus)
                                            statusText: deviceRow.effectiveStatus
                                        }
                                        ...
                                        ColumnLayout {
                                            ...
                                            Text {
                                                property string cameraName: deviceRow.cameraName
                                                property string cameraIp: deviceRow.cameraIp
                                            ...
                                            Text {
                                                Layout.fillWidth: true
                                                visible: deviceRow.effectiveDetail !== ""
                                                text: I18n.t(deviceRow.effectiveDetail)
                                                color: sidebar.isOnlineStatus(deviceRow.effectiveStatus) ? Theme.textMuted : Theme.warning
                                                font.pixelSize: 10
                                                elide: Text.ElideRight
                                            }
                                        }
                                        ...
                                        RowLayout {
                                            visible: sidebar.canSettings && deviceRowHover.hovered
                                            spacing: 4
                                                    ...
                                                    MouseArea {
                                                        ...
                                                        onClicked: {
                                                            ...
                                                            if (quickActionButton.modelData.action === "grid") {
                                                                sidebar.addCameraToGridRequested(deviceRow.rowCameraIndex)
                                                            } else if (quickActionButton.modelData.action === "majestic") {
                                                                sidebar.majesticRequested(deviceRow.rowCameraIndex)
                                                            } else if (quickActionButton.modelData.action === "health") {
                                                                sidebar.systemController.refreshCameraHealth(deviceRow.cameraIp)
                                                            }
                                                        }
                                                    }
                                                }
                                        ...
                                        Text {
                                            ...
                                            MouseArea {
                                                ...
                                                onClicked: {
                                                    ...
                                                    sidebar.systemController.removeDevice(deviceRow.rowCameraIndex)
                                                }
                                            }
                                        }
                                    }
