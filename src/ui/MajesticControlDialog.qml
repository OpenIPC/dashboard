...
Dialog {
    ...
    MajesticApplyConfirmDialog {
        id: applyConfirm
        hostWidth: dialog.width
        hostHeight: dialog.height
        pendingChanges: dialog.pendingChanges
        pipelineReloadNeeded: dialog.pendingPipelineReloadNeeded
        pipelineReloadAvailable: dialog.capabilities.pipelineReload === true
        autoReloadAfterApply: dialog.autoReloadAfterApply
        onAutoReloadAfterApplyToggled: (checked) => dialog.autoReloadAfterApply = checked
        onApplyRequested: dialog.applyPending()
    }
