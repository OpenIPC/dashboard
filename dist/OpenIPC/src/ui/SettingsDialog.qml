                ...
                Item {
                    ColumnLayout {
                        ...
                        Button {
                            text: "Report Issue"
                            Layout.alignment: Qt.AlignHCenter
                            background: Rectangle { color: "transparent"; border.color: "#4a5568"; radius: 4 }
                            contentItem: Text { text: parent.text; color: "#4299e1"; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
                        }
                    }
                }
            }
