...
function(setup_mdk_plugin tgt)
  ...
  if(STATIC_PLUGIN)
    ...
    if(CMAKE_PROJECT_NAME STREQUAL mdk)
      target_link_libraries(${tgt} PRIVATE cppcompat)
    endif()
  endif()
  if(CMAKE_PROJECT_NAME STREQUAL mdk)
...
# TODO: why RUNTIME_OUTPUT_DIRECTORY property does not work?
  ...
  set_target_properties(${tgt} PROPERTIES
    ...
    BUILD_RPATH "${RPATH_DIRS}"         # used by apple, linux
...
if(CMAKE_SYSTEM_NAME STREQUAL Linux)
  if(_IMPORT_ARCH MATCHES "[aA].*[rR].*64")
    set(_IMPORT_ARCH arm64)
  elseif(_IMPORT_ARCH MATCHES "[aA][rR][mM]")
    set(_IMPORT_ARCH armhf)
  elseif(_IMPORT_ARCH MATCHES "64")
    set(_IMPORT_ARCH amd64)
  endif()
endif()
string(TOLOWER "${_IMPORT_ARCH}" _IMPORT_ARCH)
if(WIN32)
  if(_IMPORT_ARCH MATCHES armv7) #msvc, gnu
    set(_IMPORT_ARCH arm)
  elseif(_IMPORT_ARCH MATCHES "amd64|x.*64") #msvc: amd64. gnu: x86_64
    set(_IMPORT_ARCH x64)
  elseif(_IMPORT_ARCH MATCHES "i.*86") # gnu
    set(_IMPORT_ARCH x86)
  elseif(_IMPORT_ARCH MATCHES "a.*r.*64") # msvc: arm64, arm64ec. gnu: aarch64
    set(_IMPORT_ARCH arm64)
  endif()
endif()
...
if(CMAKE_PROJECT_NAME STREQUAL mdk)
  if(NOT TARGET mdk::abi)
    ...
    set_target_properties(mdk::abi PROPERTIES
      #NO_SYSTEM_FROM_IMPORTED ON # for consumer
      IMPORTED_NO_SYSTEM ON # cmake 3.23+
