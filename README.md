Отличная идея! Добавить эту информацию в `README.md` очень важно. Я взял твой текст, добавил в него раздел про брендирование и немного улучшил форматирование для лучшей читаемости.

Вот полностью обновленный `README.md` на английском языке. Просто скопируй и замени им содержимое своего файла.
