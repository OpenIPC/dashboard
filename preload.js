...
const invokeChannels = [
    ...
    CHANNELS.GET_RENDERER_MODULES, CHANNELS.TOGGLE_ANALYTICS, 'get-analytics-states', // 'get-analytics-states' не было в твоем CHANNELS, добавил напрямую
...
const onChannels = [
    ...
    CHANNELS.ON_MEDIAMTX_STATS_UPDATE
];
